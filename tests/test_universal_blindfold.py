...
def test_universal_blindfold():
    ...
    if ("-A^2" in func_str_w or "- A^2" in func_str_w or "-1*A^2" in func_str_w) and \
       "B^2" in func_str_w and "C^2" in func_str_w and "D^2" in func_str_w and \
       "^3" not in func_str_w:
        print("STATUS: PASS")
    else:
        print("STATUS: FAIL")
    ...
    if ("A*B^2" in func_str_k or "B^2*A" in func_str_k) and "0.5" in func_str_k.replace("1/2", "0.5"):
        print("STATUS: PASS")
    else:
        print("STATUS: FAIL")
