...
class TestKnowledgeExpansion(unittest.TestCase):
    ...
    def test_abs(self):
        ...
        self.assertTrue(
            "abs(x)" in func_str or "|x|" in func_str, msg=f"Got: {func_str}"
        )
    ...
    def test_relu(self):
        ...
        self.assertTrue(
            "relu(x)" in func_str
            or "max(0, x)" in func_str
            or ("(x+|x|)/2" in func_str),
            msg=f"Got: {func_str}",
        )
    ...
    def test_tan(self):
        ...
        self.assertTrue(
            "tan(x)" in func_str or "sin(x)/cos(x)" in func_str, msg=f"Got: {func_str}"
        )
    ...
    def test_arcsin(self):
        ...
        self.assertTrue(
            "asin(x)" in func_str or "arcsin(x)" in func_str, msg=f"Got: {func_str}"
        )
