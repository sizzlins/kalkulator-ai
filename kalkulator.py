...
# f(-4),f(-3),f(-2),f(-1),f(0),f(1),f(1.5),f(2),f(3),f(4),f(5),f(6),f(7),f(8),f(9),f(10),f(11),f(12),f(e),f(pi),f(i),f(sin(1)),f(sin(pi))
# evolve --hybrid --boost 3 f(...)
# evolve --hybrid --boost 3 f(-4),f(-3),f(-2),f(-1),f(0),f(1),f(1.5),f(2),f(3),f(4),f(5),f(6),f(7),f(8),f(9),f(10),f(11),f(12),f(e),f(pi),f(i)
